...
def build_provider_config():
    """Build ONNX Runtime provider configuration for InsightFace.

    Returns the list of execution providers from globals.
    """
    providers = modules.globals.execution_providers
    # Ensure we always return a list, even if providers is None
    if not providers:
